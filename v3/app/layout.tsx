...
function BrandMark(){return <div className="realPosterLogo" role="img" aria-label="L.A Motors Stroud Ltd Automotive Specialists"/>}
...
export default function RootLayout({children}:{children:React.ReactNode}){
 ...
 <header className="siteHeader"><div className="shell navWrap"><Link href="/" className="brandLockup" aria-label="L.A Motors home"><BrandMark/></Link><nav><Link href="/">Home</Link><Link href="/cars">Used Cars</Link><Link href="/services">Services</Link><Link href="/booking">Book Online</Link><Link href="/dashboard">Dashboard</Link><a className="navPhone" href="tel:07484770941">07484 770941</a><Link className="navCta" href="/booking">Book a Service</Link></nav></div></header>
 {children}
