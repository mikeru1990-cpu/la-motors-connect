...
export default function RootLayout({children}:{children:React.ReactNode}){
 ...
 <header className="siteHeader"><div className="shell navWrap"><Link href="/" className="brandLockup" aria-label="L.A Motors Stroud Ltd home"><BrandMark/></Link><nav><Link href="/">Home</Link><Link href="/cars">Used Cars</Link><Link href="/services">Services</Link><Link href="/booking">Book Online</Link><a className="navPhone" href="tel:07484770941">07484 770941</a><Link className="navCta" href="/booking">Book a Service</Link></nav></div></header>
 {children}
 <footer><div className="shell footerGrid"><div><div className="footerBrand"><BrandMark/></div><p>Car keys, air conditioning, diagnostics, repairs, servicing and quality used vehicles in Stroud.</p></div><div><h4>Visit & Contact</h4><p>Unit 2 Butterrow Hill<br/>Bowbridge, Stroud<br/>GL5 2EE</p><a href="tel:07484770941">07484 770941</a></div><div><h4>Quick Links</h4><Link href="/cars">Vehicle Showroom</Link><Link href="/booking">Book a Service</Link><Link href="/services">Workshop Services</Link></div></div></footer>
 <nav className="mobileNav"><Link href="/"><span>⌂</span>Home</Link><Link href="/cars"><span>▱</span>Cars</Link><Link href="/booking" className="mobilePrimary"><span>＋</span>Book</Link><Link href="/services"><span>⌕</span>Services</Link><a href="tel:07484770941"><span>☎</span>Call</a></nav>
 </body></html>
}
