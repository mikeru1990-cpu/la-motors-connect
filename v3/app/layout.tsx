...
export default function RootLayout({children}:{children:React.ReactNode}){
 ...
 <header className="siteHeader"><div className="shell navWrap"><Link href="/" className="brand"><span className="logo">L.A</span><span><b>L.A MOTORS</b><small>STROUD LTD · AUTOMOTIVE SPECIALISTS</small></span></Link><nav><Link href="/services">Workshop</Link><Link href="/cars">Showroom</Link><Link href="/booking">Book Online</Link><Link href="/dashboard">Liam Dashboard</Link><a className="navCta" href="tel:07484770941">Call 07484 770941</a></nav></div></header>
 {children}
 ...
 <nav className="mobileNav"><Link href="/"><span>⌂</span>Home</Link><Link href="/cars"><span>◇</span>Showroom</Link><Link href="/booking"><span>＋</span>Book</Link><a href="tel:07484770941"><span>☎</span>Call</a></nav>
 </body></html>
}
