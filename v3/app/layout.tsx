...
function BrandMark(){return <div className="officialBrand" aria-label="L.A Motors Stroud Ltd"><div className="officialCar" aria-hidden="true"><span className="roof"/><span className="bodyLine"/><span className="wheel w1"/><span className="wheel w2"/></div><div className="officialWords"><strong>L.A MOTORS</strong><b>STROUD LTD</b><small>AUTOMOTIVE SPECIALISTS</small></div></div>}
...
export default function RootLayout({children}:{children:React.ReactNode}){
 ...
 <header className="siteHeader"><div className="shell navWrap"><Link href="/" className="brandLockup"><BrandMark/></Link><nav><Link href="/">Home</Link><Link href="/cars">Used Cars</Link><Link href="/services">Services</Link><Link href="/booking">Book Online</Link><Link href="/dashboard">Dashboard</Link><a className="navPhone" href="tel:07484770941">07484 770941</a><Link className="navCta" href="/booking">Book a Service</Link></nav></div></header>
 {children}
